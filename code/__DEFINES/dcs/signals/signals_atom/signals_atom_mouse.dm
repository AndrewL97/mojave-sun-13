...
// from base of atom/MouseDown(): (location, control, params, mob/user)
#define COMSIG_MOUSEDOWN "atom_mouse_down"
// from base of atom/MouseUp(): (location, control, params, mob/user)
#define COMSIG_MOUSEUP "atom_mouse_up"
